...
export const Hero: React.FC = () => {
  ...
  return (
    <section id="hero" className="relative w-full h-[85vh] min-h-[600px] md:min-h-[700px] overflow-hidden flex items-start pt-20 md:pt-0 md:items-center justify-center">
