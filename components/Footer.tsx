        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href={COMPANY_INFO.instagram} target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-[#F9F7F2]/10 rounded-xl flex items-center justify-center hover:bg-[#94A684] transition-colors">
                <Instagram size={20} />
              </a>
