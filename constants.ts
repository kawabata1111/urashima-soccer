...
export const FEATURES: FeatureItem[] = [
  {
    title: 'ウラトレ式「ウラトレ」',
    description: 'チーム練習では補えない「個」の力を、独自のメソッドで裏から強化します。',
    iconName: 'award',
  },
  {
    title: '少人数制＆プロ指導',
    description: '1コマ3〜5名の少人数制。経験豊富なコーチ陣がきめ細やかに指導します。',
    iconName: 'users',
  },
  {
    title: '脳トレ×運動',
...
export const URATORE_CONCEPT = {
  title: 'ウラトレとは？',
  description: '「ウラトレ式トレーニング法（ウラトレ）」は、サッカー国体選抜経験を持つ代表の浦崎が、その豊富なキャリアを活かして考案した独自のトレーニングメソッドです。チームトレーニングだけでは補いきれないフィジカル面を強化するため、個別に裏で行うトレーニングについても重点を置いています。このメソッドにより、効率的に身体を鍛え、持久力やパフォーマンスの向上を実現します。',
};